...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11023 - Abhignya  $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/abhi.wav
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/3.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/hndef.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/6.123.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{1.97}y(n - 1) + \brak{1.73}y(n - 2) \nonumber \\
	&- \brak{0.724}y(n - 3) + \brak{0.12}y(n - 4) \nonumber \\
	&= \brak{0.01}x(n) + \brak{0.04}x(n - 1) \nonumber \\
	&+ \brak{0.06}x(n - 2) + \brak{0.04}x(n - 3) \nonumber \\
	&+ \brak{0.01}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/abhignya08/Audio_Filter/blob/main/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
